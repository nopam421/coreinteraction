...
$(this).css("opacity",(counter*0.01 + 0.08));
...
if (event.key = 32) { 
  ...
  if(loop == undefined){
    ...
    loop = setInterval(function(){
        ...
        $("#circle_" + countUp).css("background-color", '#FFFFFF');
        $("#circle_" + countUp).css("opacity", 1);


        $("#circle_" + (countUp-1)).css("background-color", '#FF872E');
        $("#circle_" + (countUp-1)).css("opacity", (countUp*0.01 + 0.08));

        var lastIndex = countUp-1; 
        if(lastIndex == -1) lastIndex = 100; 
        $("#circle_" + lastIndex).css("background-color", '#FF872E');
        $("#circle_" + lastIndex).css("opacity", ("#circle_100" *0.01 + 0.08));
